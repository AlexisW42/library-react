...
function Header() {
  ...
  return (
    <div className="transition delay-75 h-fit mb-4 bg-indigo-900 text-gray-200 dark:bg-slate-900 dark:border-b-2 dark:border-b-slate-800">
      <nav>
        <div className="flex flex-wrap justify-between p-4 items-center md:justify-between mx-auto">
          <div className="px-6 justify-center col-start-1 text-3xl">
            Library
          </div>
